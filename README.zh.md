...
> **立即在浏览器中使用:** [**songmalkang.github.io/DRG_MissionTracker_Mobile**](https://songmalkang.github.io/DRG_MissionTracker_Mobile/) — 可在任何平台上安装为 PWA。
...
- **BOSCO 推送通知** — 双倍经验任务出现时立即收到通知。可自定义提醒的星期、时间和任务类型。*(Android 和 PC 浏览器)*
...
| 平台 | 支持情况 | 通知 | 备注 |
|---|---|---|---|
| Android | ✅ 完整 | ✅ 后台推送 | 通过 [APK 下载](https://github.com/SongMalkang/DRG_MissionTracker_Mobile/releases) 安装 |
| Web (PC) | ✅ 完整 | ✅ 浏览器通知 | [在浏览器中打开](https://songmalkang.github.io/DRG_MissionTracker_Mobile/) · 可安装为 PWA |
| iOS | ⚠️ 部分 | ❌ 不支持 | 通过 Safari "添加到主屏幕" 安装 PWA · 未上架 App Store |
| Web (移动端) | ⚠️ 部分 | ❌ 不支持 | 可安装 PWA 但无法接收通知 |
...
| 平台 | 工作方式 |
|---|---|
| **Android** | 通过 AlarmManager 后台推送 — 即使应用关闭也能工作 |
| **PC 浏览器 / PWA** | Web Notification API — 浏览器或 PWA 窗口打开时工作 |
| **移动浏览器 / iOS** | 因平台限制不支持通知 |

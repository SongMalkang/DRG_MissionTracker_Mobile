const Map<String, Map<String, String>> i18n = {
  'KR': {
    ...
    'notif_web_note': 'PC 브라우저에서만 알림이 지원됩니다. 모바일(Android/iOS)에서는 알림을 받을 수 없습니다.',
    'notif_time_from': '시작',
    'notif_time_to': '종료',
    'notif_time': '알림 시간',
    'notif_days': '활성 요일',
  ...
  'EN': {
    ...
    'notif_web_note': 'Notifications are only supported on PC browsers. Mobile (Android/iOS) cannot receive notifications.',
  ...
  'CN': {
    ...
    'notif_web_note': '仅PC浏览器支持通知。移动端（Android/iOS）无法接收通知。',
    'notif_time_from': '开始',
    'notif_time_to': '结束',
    'notif_time': '提醒时间',
    'notif_days': '活跃日',

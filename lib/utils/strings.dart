const Map<String, Map<String, String>> i18n = {
  'KR': {
    ...
    'watchlist_android_only': '하이라이트는 모든 플랫폼에서 작동하지만, Push 알림은 Android에서만 지원됩니다.',
    // Home Widget
  ...
  'EN': {
    ...
    'watchlist_android_only': 'Highlighting works on all platforms, but push alerts are only available on Android.',
    // Home Widget
    'widget_title': 'BOSCO TERMINAL',
  ...
  'CN': {
    ...
    'watchlist_android_only': '高亮功能适用于所有平台，但Push提醒仅支持Android。',
    // Home Widget
    'widget_title': '博斯科终端',
    'widget_no_xp': '无双倍经验',

const Map<String, Map<String, String>> i18n = {
  'KR': {
    ...
    // Notification
    'notif_settings': '미션 알림 설정',
    'notif_enable': '알림 활성화',
    'notif_time': '알림 시간',
    'notif_days': '활성 요일',
    'notif_exclude_types': '미션 타입 필터',
    'notif_exclude_note': '체크 해제된 미션 타입은 알림에서 제외됩니다.',
    'notif_title': '보스코 터미널',
    'notif_body_prefix': '흥미로운 미션 발견!',
  ...
  'EN': {
    ...
    // Notification
    'notif_settings': 'Mission Alert Settings',
    'notif_enable': 'Enable Alerts',
    'notif_time': 'Alert Time',
    'notif_days': 'Active Days',
    'notif_exclude_types': 'Mission Type Filter',
    'notif_exclude_note': 'Unchecked mission types will be excluded from alerts.',
    'notif_title': 'Bosco Terminal',
    'notif_body_prefix': 'Interesting missions found!',
  ...
  'CN': {
    ...
    // Notification
    'notif_settings': '任务提醒设置',
    'notif_enable': '启用提醒',
    'notif_time': '提醒时间',
    'notif_days': '活跃日',
    'notif_exclude_types': '任务类型过滤',
    'notif_exclude_note': '未勾选的任务类型将不会收到提醒。',
    'notif_title': '博斯科终端',
    'notif_body_prefix': '发现有趣的任务！',

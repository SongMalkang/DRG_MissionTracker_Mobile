    ...
    weapons: [
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'driller_crspr_sticky_additive', name: 'Sticky Additive', tier: OverclockTier.clean, effect: '+1 Damage, +1s Sticky Flame Duration', icon: 'icon_upgrade_duration_v2'),
          Overclock(id: 'driller_crspr_compact_feed_valves', name: 'Compact Feed Valves', tier: OverclockTier.balanced, effect: '+25 Max Fuel, -2 Damage', icon: 'icon_upgrade_clip_size'),
      ...
      Weapon(
        ...
        isPrimary: true,
        overclocks: [
          Overclock(id: 'driller_cryo_improved_thermal_efficiency', name: 'Improved Thermal Efficiency', tier: OverclockTier.clean, effect: '+25 Tank Capacity, -0.2 Chargeup Time', icon: 'icon_upgrade_clip_size'),
      ...
      Weapon(
        ...
        isPrimary: true,
        overclocks: [
          Overclock(id: 'driller_sludge_hydrogen_ion_additive', name: 'Hydrogen Ion Additive', tier: OverclockTier.clean, effect: '+1 Damage, +30% Corrosive DoT Duration', icon: 'icon_upgrade_acid'),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'driller_subata_explosive_reload', name: 'Explosive Reload', tier: OverclockTier.unstable, effect: 'Last 3 bullets in magazine deal AoE damage, -50% Max Ammo, -50% Magazine Size', icon: 'icon_overclock_special_magazine'),
      ...
      Weapon(
        ...
        isPrimary: false,
        overclocks: [
          Overclock(id: 'driller_epc_energy_rerouting', name: 'Energy Rerouting', tier: OverclockTier.clean, effect: '+16 Charged Shot Damage, -32 Battery Capacity', icon: 'icon_upgrade_charge_up'),
          Overclock(id: 'driller_epc_magnetic_cooling_unit', name: 'Magnetic Cooling Unit', tier: OverclockTier.clean, effect: '+25% Cooling Rate, +50% Charge Speed', icon: 'icon_upgrade_temperature_cool_down'),
          ...
          Overclock(id: 'driller_epc_overcharger', name: 'Overcharger', tier: OverclockTier.unstable, effect: '+50% Charged Damage, +50% Charged AoE, +50% Charged Shot Ammo Use, No Charged Shot Terrain Damage', icon: 'icon_upgrade_damage_general'),
          Overclock(id: 'driller_epc_persistent_plasma', name: 'Persistent Plasma', tier: OverclockTier.unstable, effect: 'Charged Shot leaves plasma field (6s), -20 Charged Shot Damage, -20 Battery', icon: 'icon_upgrade_duration_v2'),
        ],
      ),
      ...
      Weapon(
        ...
        isPrimary: false,
        overclocks: [
          Overclock(id: 'driller_colette_liquid_cooling_system', name: 'Liquid Cooling System', tier: OverclockTier.clean, effect: '+25% Cooling Rate, -50% Overheat Duration', icon: 'icon_upgrade_temperature_cool_down'),
          Overclock(id: 'driller_colette_super_focus_lens', name: 'Super Focus Lens', tier: OverclockTier.clean, effect: '+4 Damage, -0.5m Beam Width', icon: 'icon_upgrade_aim'),
          Overclock(id: 'driller_colette_diffusion_ray', name: 'Diffusion Ray', tier: OverclockTier.balanced, effect: '+1.5m Beam Width, -2 Damage, Reduced Range', icon: 'icon_upgrade_bullet_penetration'),
          ...
          Overclock(id: 'driller_colette_blistering_necrosis', name: 'Blistering Necrosis', tier: OverclockTier.unstable, effect: 'Damage leaves permanent damage bonus on enemies, -50 Ammo, -1 Damage', icon: 'icon_upgrade_weakspot'),
    ...
    weapons: [
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'engineer_warthog_light_weight_magazines', name: 'Light-Weight Magazines', tier: OverclockTier.clean, effect: '+2 Magazine Size, +0.4 Reload Speed', icon: 'icon_upgrade_ammo'),
          ...
          Overclock(id: 'engineer_warthog_mini_shells', name: 'Mini Shells', tier: OverclockTier.unstable, effect: '+90 Max Ammo, +6 Magazine Size, -2 Damage, No Stun, No Stagger', icon: 'icon_overclock_small_bullets'),
          Overclock(id: 'engineer_warthog_pump_action', name: 'Pump Action', tier: OverclockTier.unstable, effect: '+5 Damage, +2 Pellets, Blowthrough, -33% Max Ammo, -20% Magazine Size, -55% Rate of Fire', icon: 'icon_upgrade_bullet_penetration'),
        ],
      ),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'engineer_stubby_em_refire_booster', name: 'EM Refire Booster', tier: OverclockTier.balanced, effect: '+2 Electric Damage, +4 Rate of Fire, x1.5 Base Spread', icon: 'icon_upgrade_fire_rate'),
      ...
      Weapon(
        ...
        isPrimary: true,
        overclocks: [
          Overclock(id: 'engineer_lok1_eraser', name: 'Eraser', tier: OverclockTier.clean, effect: '+12 Max Locks-On, +33% Lock-On Range', icon: 'icon_upgrade_clip_size'),
          ...
          Overclock(id: 'engineer_lok1_explosive_chemical_rounds', name: 'Explosive Chemical Rounds', tier: OverclockTier.balanced, effect: 'Full lock burst causes AoE explosion, -20% Lock-On Range, -10 Max Ammo', icon: 'icon_upgrade_explosion'),
          Overclock(id: 'engineer_lok1_seeker_rounds', name: 'Seeker Rounds', tier: OverclockTier.balanced, effect: 'Bullets curve around obstacles, -15 Max Ammo, -1 Damage', icon: 'icon_upgrade_aim'),
          Overclock(id: 'engineer_lok1_neuro_lasso', name: 'Neuro-Lasso', tier: OverclockTier.balanced, effect: 'Slows locked targets, 8s lock duration limit', icon: 'icon_upgrade_sticky'),
          Overclock(id: 'engineer_lok1_executioner', name: 'Executioner', tier: OverclockTier.unstable, effect: '+50% Weakpoint Bonus at Full Lock, Faster lock acquisition, Reduced ammo and magazine size', icon: 'icon_upgrade_weakspot'),
          Overclock(id: 'engineer_lok1_smart_trigger_os', name: 'Smяt Trigger OS™', tier: OverclockTier.unstable, effect: 'Automatic fire with near-instant lock-on, Drastically reduced max lock capacity', icon: 'icon_upgrade_light'),
        ],
      ),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'engineer_pgl_rj250_compound', name: 'RJ250 Compound', tier: OverclockTier.balanced, effect: 'Launcher jump ability, -25 Area Damage', icon: 'icon_overclock_explosion_jump'),
          Overclock(id: 'engineer_pgl_fat_boy', name: 'Fat Boy', tier: OverclockTier.unstable, effect: '+300 Area Damage (Radiation), Leaves radiation zone, -70% Max Ammo, -70% AoE Radius', icon: 'icon_upgrade_area_damage'),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'engineer_bc_roll_control', name: 'Roll Control', tier: OverclockTier.clean, effect: '+25% Beam Width, Beam rotates 90 degrees', icon: 'icon_overclock_spinning_linecutter'),
          ...
          Overclock(id: 'engineer_bc_return_to_sender', name: 'Return to Sender', tier: OverclockTier.balanced, effect: 'Beam reverses direction on trigger release, -6 Max Ammo', icon: 'icon_overclock_forth_and_back_linecutter'),
          ...
          Overclock(id: 'engineer_bc_spinning_death', name: 'Spinning Death', tier: OverclockTier.unstable, effect: 'Beam spins and moves slowly, +150% Beam Width, +250% Projectile Lifetime, -50% Beam DPS, -2 Max Ammo', icon: 'icon_upgrade_special'),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'engineer_sd_automated_beam_controller', name: 'Automated Beam Controller', tier: OverclockTier.balanced, effect: '+100 Ammo, +4 Discharge Rate, -0.2 Recharge Time, Continuous fire until empty', icon: 'icon_upgrade_fire_rate'),
          Overclock(id: 'engineer_sd_feedback_loop', name: 'Feedback Loop', tier: OverclockTier.balanced, effect: 'Increases radius and damage of AoE while beam fires, Stacks continuously', icon: 'icon_upgrade_area'),
          Overclock(id: 'engineer_sd_volatile_impact_reactor', name: 'Volatile Impact Reactor', tier: OverclockTier.balanced, effect: 'Turns terrain into magma that damages and ignites enemies', icon: 'icon_upgrade_special'),
          Overclock(id: 'engineer_sd_plastcrete_catalyst', name: 'Plastcrete Catalyst', tier: OverclockTier.unstable, effect: 'Reacts with plascrete platforms, increasing AoE damage and range, Triggers explosions', icon: 'icon_upgrade_explosion'),
    ...
    weapons: [
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'gunner_minigun_thinned_drum_walls', name: 'Thinned Drum Walls', tier: OverclockTier.clean, effect: '+300 Max Ammo, -1s Cooling Time', icon: 'icon_upgrade_temperature_cool_down'),
          ...
          Overclock(id: 'gunner_minigun_rotary_overdrive', name: 'Rotary Overdrive', tier: OverclockTier.balanced, effect: '+12 QUIK-CHILL Coolant Charges, +3 Rate of Fire, +75% Heat Generation', icon: 'icon_upgrade_temperature_cool_down'),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'gunner_autocannon_combat_mobility', name: 'Combat Mobility', tier: OverclockTier.balanced, effect: '+50% Movement Speed while firing, +0.2 Reload Time', icon: 'icon_upgrade_movement_speed'),
          ...
          Overclock(id: 'gunner_autocannon_neurotoxin_payload', name: 'Neurotoxin Payload', tier: OverclockTier.unstable, effect: '50% chance to inflict neurotoxin, +0.25m AoE Radius, -6 Area Damage, -110 Max Ammo', icon: 'icon_overclock_neuro'),
          Overclock(id: 'gunner_autocannon_mortar_rounds', name: 'Mortar Rounds', tier: OverclockTier.unstable, effect: 'Slow arcing projectiles, x7 Area Damage, x1.25 AoE Radius, Severely reduced Magazine/Ammo/Rate of Fire', icon: 'icon_overclock_last_shell_higher_damage'),
        ],
      ),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'gunner_hurricane_plasma_burster_missiles', name: 'Plasma Burster Missiles', tier: OverclockTier.balanced, effect: 'Multi-burst missiles with penetration, +30% Turn Rate, Reduced damage and velocity', icon: 'icon_upgrade_bullet_penetration'),
          Overclock(id: 'gunner_hurricane_minelayer_system', name: 'Minelayer System', tier: OverclockTier.balanced, effect: 'Missiles plant as mines on terrain impact, Unguided missiles', icon: 'icon_upgrade_special'),
          Overclock(id: 'gunner_hurricane_rocket_barrage', name: 'Rocket Barrage', tier: OverclockTier.unstable, effect: 'x3 Rate of Fire, +216 Max Ammo, No guidance, Reduced damage', icon: 'icon_upgrade_distance'),
          ...
          Overclock(id: 'gunner_hurricane_salvo_module', name: 'Salvo Module', tier: OverclockTier.unstable, effect: 'Charge to fire up to 9 unguided missiles simultaneously with damage scaling', icon: 'icon_upgrade_shotgun_blast'),
          Overclock(id: 'gunner_hurricane_cluster_charges', name: 'Cluster Charges', tier: OverclockTier.unstable, effect: 'Hold reload to release 7 bomblets from missiles, x2 Damage, Reduced capacity', icon: 'icon_overclock_special_magazine'),
        ],
      ),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'gunner_bulldog_six_shooter', name: 'Six Shooter', tier: OverclockTier.balanced, effect: '+2 Rate of Fire, +8 Max Ammo, -2 Damage', icon: 'icon_upgrade_clip_size'),
          ...
          Overclock(id: 'gunner_bulldog_magic_bullets', name: 'Magic Bullets', tier: OverclockTier.unstable, effect: 'Bullets home to weakpoints, -20% Damage, -4 Max Ammo', icon: 'icon_upgrade_ricoshet'),
        ],
      ),
      ...
      Weapon(
        ...
        isPrimary: false,
        overclocks: [
          Overclock(id: 'gunner_brt7_composite_casings', name: 'Composite Casings', tier: OverclockTier.clean, effect: '+36 Max Ammo, +1 Rate of Fire', icon: 'icon_upgrade_fire_rate'),
          ...
          Overclock(id: 'gunner_brt7_micro_flechettes', name: 'Micro Flechettes', tier: OverclockTier.unstable, effect: '+120 Max Ammo, -3 Damage, +100% Weakpoint Bonus', icon: 'icon_overclock_small_bullets'),
          Overclock(id: 'gunner_brt7_lead_spray', name: 'Lead Spray', tier: OverclockTier.unstable, effect: 'Fires 12 pellets (shotgun), -50% Weakpoint Bonus, +100% Spread', icon: 'icon_upgrade_special'),
        ],
      ),
      ...
      Weapon(
        ...
        isPrimary: false,
        overclocks: [
          Overclock(id: 'gunner_coilgun_re_atomizer', name: 'Re-Atomizer', tier: OverclockTier.clean, effect: '+40 Ammo, +0.4m Trail AoE Radius', icon: 'icon_upgrade_special'),
          Overclock(id: 'gunner_coilgun_ultra_magnetic', name: 'Ultra-Magnetic', tier: OverclockTier.clean, effect: '+50% Charge Speed, Reduces Charge Shot Base Spread', icon: 'icon_upgrade_duration_v2'),
          ...
          Overclock(id: 'gunner_coilgun_the_mole', name: 'The Mole', tier: OverclockTier.balanced, effect: 'Shots penetrate terrain, -10 Ammo, -50% Charge Speed', icon: 'icon_upgrade_bullet_penetration'),
  ...
  DwarfCharacter(
    ...
    weapons: [
      ...
      Weapon(
        ...
        isPrimary: true,
        overclocks: [
          Overclock(id: 'scout_gk2_compact_ammo', name: 'Compact Ammo', tier: OverclockTier.clean, effect: '+5 Magazine Size, +100 Max Ammo', icon: 'icon_upgrade_clip_size'),
      ...
      Weapon(
        ...
        isPrimary: true,
        overclocks: [
          Overclock(id: 'scout_m1000_hoverclock', name: 'Hoverclock', tier: OverclockTier.clean, effect: 'Focused shot hovers in air, -20 Max Ammo', icon: 'icon_overclock_slowdown'),
          Overclock(id: 'scout_m1000_minimal_clips', name: 'Minimal Clips', tier: OverclockTier.clean, effect: '+16 Max Ammo, -0.4 Reload Time', icon: 'icon_upgrade_clip_size'),
          Overclock(id: 'scout_m1000_active_stability_system', name: 'Active Stability System', tier: OverclockTier.balanced, effect: '+70% Focus Speed, +20% Focused Shot Damage, -20 Max Ammo', icon: 'icon_upgrade_movement_speed'),
          Overclock(id: 'scout_m1000_hipster', name: 'Hipster', tier: OverclockTier.balanced, effect: '+3 Rate of Fire, -14 Max Ammo, -25% Focus Speed, +175% Recoil', icon: 'icon_upgrade_aim'),
          ...
          Overclock(id: 'scout_m1000_marked_for_death', name: 'Marked for Death', tier: OverclockTier.unstable, effect: 'Focus shots mark enemies to take +55% damage from all sources for 8s, Reduced direct damage', icon: 'icon_upgrade_weakspot'),
        ],
      ),
      ...
      Weapon(
        ...
        isPrimary: true,
        overclocks: [
          Overclock(id: 'scout_drak_aggressive_venting', name: 'Aggressive Venting', tier: OverclockTier.clean, effect: 'Overheat creates burn AoE, -20% Overheat Duration', icon: 'icon_upgrade_special'),
          Overclock(id: 'scout_drak_thermal_liquid_coolant', name: 'Thermal Liquid Coolant', tier: OverclockTier.clean, effect: '+25% Cooling Rate, -15% Heat per Shot', icon: 'icon_upgrade_temperature_cool_down'),
          ...
          Overclock(id: 'scout_drak_conductive_thermals', name: 'Conductive Thermals', tier: OverclockTier.balanced, effect: 'Applies temporary fire/ice/electric damage buff on hit, -3 Damage, +37% Heat per Shot', icon: 'icon_upgrade_temperature'),
          Overclock(id: 'scout_drak_rewiring_mod', name: 'Rewiring Mod', tier: OverclockTier.balanced, effect: 'Generates ammo while overheated, +30% Overheat Duration, -30% Battery Capacity', icon: 'icon_upgrade_ammo'),
          ...
          Overclock(id: 'scout_drak_shield_battery_booster', name: 'Shield Battery Booster', tier: OverclockTier.unstable, effect: 'Increased damage and projectile speed at full shield, +1 Rate of Fire, +100 Battery, -50% Cooling Rate, x1.5 Heat per Shot', icon: 'icon_upgrade_resistance'),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'scout_boomstick_special_powder', name: 'Special Powder', tier: OverclockTier.clean, effect: 'Shooting propels you (shotgun jump)', icon: 'icon_overclock_shotgun_jump'),
          Overclock(id: 'scout_boomstick_stuffed_shells', name: 'Stuffed Shells', tier: OverclockTier.clean, effect: '+1 Damage, +1 Pellets', icon: 'icon_upgrade_shotgun_pellet'),
          ...
          Overclock(id: 'scout_boomstick_double_barrel', name: 'Double Barrel', tier: OverclockTier.unstable, effect: 'x5.5 Front AoE Shock Wave Damage, x2 Pellets, -50% Magazine Size, -50% Max Ammo, x2 Recoil, x1.5 Base Spread', icon: 'icon_upgrade_special'),
        ],
      ),
      // ── Zhukov NUK17 (5 OCs) ──
      Weapon(
        ...
        isPrimary: false,
        overclocks: [
          Overclock(id: 'scout_zhukov_minimal_magazines', name: 'Minimal Magazines', tier: OverclockTier.clean, effect: '+75 Max Ammo, -0.4 Reload Time', icon: 'icon_upgrade_speed'),
          Overclock(id: 'scout_zhukov_custom_casings', name: 'Custom Casings', tier: OverclockTier.balanced, effect: '+30 Max Ammo, +1 Rate of Fire, -2 Damage', icon: 'icon_upgrade_clip_size'),
          ...
          Overclock(id: 'scout_zhukov_embedded_detonators', name: 'Embedded Detonators', tier: OverclockTier.unstable, effect: 'Reload detonates embedded bullets, -6 Damage, -20 Magazine Size, -400 Max Ammo', icon: 'icon_overclock_special_magazine'),
      ...
      Weapon(
        ...
        overclocks: [
          ...
          Overclock(id: 'scout_boltshark_the_specialist', name: 'The Specialist', tier: OverclockTier.clean, effect: '+30% Weakpoint Bonus, +15% Focus Speed', icon: 'icon_upgrade_special'),
          ...
          Overclock(id: 'scout_boltshark_bodkin_points', name: 'Bodkin Points', tier: OverclockTier.unstable, effect: '+100% Armor Breaking, +20% Weakpoint Bonus, -30 Direct Damage', icon: 'icon_upgrade_ricoshet'),
          Overclock(id: 'scout_boltshark_trifork_volley', name: 'Trifork Volley', tier: OverclockTier.unstable, effect: 'Fires 3 bolts, -33% Direct Damage per bolt, +5 Max Ammo', icon: 'icon_overclock_last_shell_higher_damage'),
        ],
      ),
    ],
  ),
